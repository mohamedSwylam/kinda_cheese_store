                  ...
                  body: Padding(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return FullCart(
                          id:  StoreAppCubit.get(context).getCartItems.values.toList()[index].id,
                           productId: StoreAppCubit.get(context).getCartItems.keys.toList()[index],
                          price: StoreAppCubit.get(context).getCartItems.values.toList()[index].price,
                           title: StoreAppCubit.get(context).getCartItems.values.toList()[index].title,
                           imageUrl: StoreAppCubit.get(context).getCartItems.values.toList()[index].imageUrl,
                           quantity: StoreAppCubit.get(context).getCartItems.values.toList()[index].quantity,
                        );
                      },
